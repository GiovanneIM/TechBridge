                ...
                <div data-slot="card" className="flex flex-col rounded-xl border bg-card py-10 text-card-foreground shadow-sm relative w-full max-w-sm overflow-hidden pt-0 pb-4 gap-4">
                    ...
                    <div>
                        ...
                        <div data-slot="card-content" class="px-4">
                            <ul class="text-muted-foreground text-justify font-genty">
                                <li class="mt-2"></li>
                                <li class="mt-2"></li>
                                <li class="mt-2"></li>
                            </ul>
...
const setores = [
    {
        value: "setor-1",
        nome: "Ferramentaria",
        icone: <Wrench className="text-techbridge h-15 w-20 pt-4" />,
        span: "Ferramental"
    },
    {
        value: "setor-2",
        nome: "RH",
        icone: <BriefcaseBusiness className="text-techbridge h-15 w-20 pt-4" />,
        span: " Gestão de pessoas"
    },
    {
        value: "setor-3",
        nome: "Pintura",
        icone: <PaintRoller className="text-techbridge h-15 w-20 pt-4" />,
        span: "Acabamento"
    },
    {
        value: "setor-4",
        nome: "GA",
        icone: <Network className="text-techbridge h-15 w-20 pt-4" />,
        span: "Logística"
    },
]
...
import { Grid2x2, Grid2X2, RotateCw } from 'lucide-react';
...
import SkeletonLinhaUm from '../Dashboard/teste/Skeletons/LinhaUm';
import SkeletonEstadosCards from '../Dashboard/teste/Skeletons/EstadosCards';
...
export default function PageDashboard({
	...
	// Holder de loading
	if (isFirstLoad) {
		return <LoadingPage loadingTitle="Carregando dashboard" loadingSubtitle={["Aguarde alguns segundos"]} />
	}

	// Holder de erro
	if (errorDashboard) {
		return <ErrorPage errorTitle={"Erro ao carregar dashboard"} errorSubtitle={["Houve um erro ao carregar seu dashboard", "por favor recarregue a página para tentar novamente"]} />
	}
	...
	if (loadingDashboard) {
		return (
			<div className='flex-1 flex flex-col'>
				...
				<HeaderPage
					icon={<Grid2X2 />} title={"Dashboard"}
					buttonAction={refetchDashboard} buttonIcon={<RotateCw />} buttonText={"Recarregar Dashboard"}
				/>

				{/* Dados carregados sem erro */}
	...
	return (
		<div className='flex-1 flex flex-col'>
			...
			<HeaderPage
				icon={<Grid2X2 className='-ml-1' />} title={"Dashboard"}
				buttonAction={refetchDashboard} buttonIcon={<RotateCw />} buttonText={"Recarregar Dashboard"}
			/>

    ...
    return (
        <div className='flex-1 flex flex-col'>
            ...
            <div className="
                ...
                justify-center items-center xl:items-stretch
                gap-4 mb-12 mt-4 px-2 sm:px-4
            ">
                ...
                <div className="w-full xl:w-1/2 flex flex-col gap-4">
                    ...
                    <Card className="w-full py-5 px-4">
                        ...
                        <CardHeader className="m-0 p-0">
                            <CardTitle className={'text-2xl font-genty font-normal'}>
                                Perguntas Frequentes
                            </CardTitle>
                        ...
                        <CardContent className="m-0 p-0">
                            ...
                            >
                                {items.map((item) => (
                                    ...
                                    >
                                        <AccordionTrigger
                                            className={'p-4 font-bold text-sm shadow-sm hover:shadow-md mb-4'}
                                        >
                                            {item.trigger}
                                        </AccordionTrigger>

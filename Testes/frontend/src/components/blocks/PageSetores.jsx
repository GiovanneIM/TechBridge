    ...
    return (
        <div className='flex-1 flex flex-col'>
            ...
            <div className="flex flex-row gap-3 items-center justify-center p-5">
                {/* Card dos setores */}
                {setores.map((setor, i) => (
                    <div key={i} data-slot="card" className="flex flex-col rounded-xl border bg-card py-10 text-card-foreground shadow-sm relative w-full max-w-sm overflow-hidden pt-0 pb-4 gap-4">
                        <div>
                            <div>{setor.icone}</div>
                        </div>
                        <div>
                            <div data-slot="card-header" className="@container/card-header grid auto-rows-min grid-rows-[auto_auto] items-start gap-2 has-data-[slot=card-action]:grid-cols-[1fr_auto] [.border-b]:pb-6 px-4">
                                ...
                                <div data-slot="card-title" className="font-semibold text-techbridge font-genty text-2xl">
                                    {setor.nome}
                                </div>
